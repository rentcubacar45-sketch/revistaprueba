...
boss = ['gatitoomiauu','YacielCL']#usuarios supremos
...
total_up = {'darielxd':{'P':0,'S':0},'YacielCL':{'P':0,'S':0},'darielxd':{'P':0,'S':0}} #total en gb o megas subidos en bytes (int)
rvs = {'darielxd':{'h':'','u':'','p':'','up':'','z':0,'m':'m'}}
